...
function addSubject() {
    if (subjectCount <= 20) {
        ...
        label1.htmlFor = `c_5_sub_${subjectCount}_name`;
        ...
        input1.type = 'text';
        input1.id = `c_5_sub_${subjectCount}_name`;
        input1.name = `c_5_sub_${subjectCount}_name`;
        ...
        label2.htmlFor = `c_5_sub_${subjectCount}_marks_obtained`;
        ...
        input2.type = 'text';
        input2.id = `c_5_sub_${subjectCount}_marks_obtained`;
        input2.name = `c_5_sub_${subjectCount}_marks_obtained`;
        ...
        label3.htmlFor = `c_5_sub_${subjectCount}_total_marks`;
        ...
        input3.type = 'text';
        input3.id = `c_5_sub_${subjectCount}_total_marks`;
        input3.name = `c_5_sub_${subjectCount}_total_marks`;
